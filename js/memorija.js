var karte = [
  {
    ime: "kornjaca",
    slika: "img/kornjaca.png",
  },
  {
    ime: "zvezda",
    slika: "img/zvezda.png",
  },
  {
    ime: "kljuc",
    slika: "img/kljuc.png",
  ...
  {
    ime: "princeza",
    slika: "img/princeza.png",
  },
  {
    ime: "zelena",
    slika: "img/zelena.png",
  },
  {
    ime: "crvena",
    slika: "img/crvena.png",
  },
  {
    ime: "djavo",
    slika: "img/djavo.png",
...
okvir.addEventListener("click", function (x) {
  var klik = x.target;
  if (
    klik.nodeName === "SECTION" ||
    klik.parentNode.classList.contains("izabrana") ||
    klik.parentNode.classList.contains("pogodak")
  ) {
    return;
  }
  if (broj < 2) {
